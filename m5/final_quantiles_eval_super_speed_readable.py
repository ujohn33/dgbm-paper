...
# -*- coding: utf-8 -*-
"""
Executable script for evaluating quantile forecasts on levels 13, 14, 15 with SUPER_SPEED only.
"""
import pandas as pd
import numpy as np
...
def main():
    ...
    # Filter for levels 13, 14, 15 and SUPER_SPEED only
    df = df[df['level'].isin([13, 14, 15])]
    df = df[df['speed'] == 'SUPER_SPEED']
